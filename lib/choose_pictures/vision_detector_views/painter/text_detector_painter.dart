  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (final textBlock in recognizedText.blocks) {
      ...
      final top = translateY(textBlock.boundingBox.top, size, imageSize,
          rotation, cameraLensDirection);
      final right = translateX(textBlock.boundingBox.right, size, imageSize,
          rotation, cameraLensDirection);
          ...
          switch (cameraLensDirection) {
            ...
            case CameraLensDirection.back:
              switch (rotation) {
                ...
                case InputImageRotation.rotation90deg:
                  x = size.width -
                      translateX(point.y.toDouble(), size, imageSize, rotation,
                          cameraLensDirection);
                  y = translateY(point.x.toDouble(), size, imageSize, rotation,
                      cameraLensDirection);
                  break;
              }
              break;
